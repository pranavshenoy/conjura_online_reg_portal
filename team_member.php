<?php echo "<h4 class='teamEvent'><span class='teamEventdetails'>Additional member details of </span><br><br>".$row['event_display']."</h4>"; ?>
...
<div class='form-group'>
		<div class="col-xs-12">
		    ...
		    <div style="padding-top: 0; padding-left: 1px;" class="radio">
		      <label style="padding-right: 8px;"><input type="radio" value="m" id="sw" name=<?php echo "gender".$e_team_temp ?> required>&nbsp;&nbsp;Male</label>
		      <label><input type="radio" value="f" id="sw" name=<?php echo "gender".$e_team_temp ?> required>&nbsp;&nbsp;Female</label>
		    </div>
		  </div>
